...
# Report success in Danger tests if no warnings were generated
if is_good_pr
  message("PR passed all labeling tests. It is small enough, doesn't contain merge-commits and doesn't change non-EN translations!")
  auto_label.set(pr_number, "Good", "DAFBE1")
else
  auto_label.remove("Good")
end
